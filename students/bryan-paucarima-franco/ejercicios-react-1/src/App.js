...
// import PrintBoolean from './components/booleano';
import EventsExample from './components/event-example';
import StateExample from './components/state-example';
import DemoFetch from './components/demo-fetch';
import DemoUseEffect from './components/demo-use-effects';
...
return (
  <React.Fragment>
    {/* <Greetin name='Bryan' age='28'></Greetin>

    <PrintBoolean isCircle = {true}></PrintBoolean>
    <PrintBoolean isCircle = {false}></PrintBoolean> */}
    {/* <UserCard userObj={user}></UserCard>
    <UsersList arrayObj={users}></UsersList> */}
